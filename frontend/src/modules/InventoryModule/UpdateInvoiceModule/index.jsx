...
import InventoryForm from '@/modules/InvoiceModule/Forms/InventoryForm';
...
export default function UpdateInventoryModule({ config }) {
  ...
  if (isLoading) {
    ...
    return (
      <ErpLayout>
        {isSuccess ? (
          <UpdateItem config={config} UpdateForm={InventoryForm} />
        ) : (
          <Result
            status="404"
