...
export default function PaymentInvoiceForm({ form, subTotal = 0, current = null }) {
  ...
  console.log('CEK FORM outside', form);
      ...
      <Col className="gutter-row" span={5}>
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: 'Please input the invoice!',
            },
          ]}
        >
          <AutoCompleteAsync
            entity={'invoice'}
            displayLabels={['number', 'note']}
