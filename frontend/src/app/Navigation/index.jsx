...
import logoText from '@/style/images/kbs.png';
...
const SIDEBAR_MENU = [
  ...
  { key: '/invoice-dashboard', icon: <DashboardOutlined />, title: 'Invoice Dashboard' },
  { key: '/inventory', icon: <DropboxOutlined />, title: 'Inventory' },
        ...
        <div className="logo" onClick={() => history.push('/')} style={{ cursor: 'pointer' }}>
          ...
          {!showLogoApp && (
            <img
              src={logoText}
              alt="Logo"
              style={{ marginTop: '3px', marginLeft: '10px', height: '42px' }}
            />
          )}
        </div>
